package digipodium.broadcastreceiver;
...
public class FirstFragment extends Fragment {
    ...
    public void updateUI(int state) {
        switch (state) {
            case 1:
                imgPower.setImageResource(R.drawable.ic_baseline_power_100);
                wrapper.setBackgroundColor(Color.argb(100, 100, 255, 100));
                break;
            case 0:
                imgPower.setImageResource(R.drawable.ic_baseline_power_off_100);
